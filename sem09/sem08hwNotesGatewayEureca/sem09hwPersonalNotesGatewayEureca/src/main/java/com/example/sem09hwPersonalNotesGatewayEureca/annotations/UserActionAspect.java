package com.example.sem09hwPersonalNotesGatewayEureca.annotations;
...
public class UserActionAspect {
    ...
    @Before("@annotation(com.example.sem09hwPersonalNotesGatewayEureca.annotations.TrackUserAction)")
